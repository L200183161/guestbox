...
?>
    ...
    <head>
        ...
        <title>GUESTBOOK - Chats View</title>
        <!-- Favicon-->
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header bg-blue">
                                <h2>
                                    List of Chated <small>The page that is dedicated to admin only 👌</small>
                                </h2>
                            </div>
                            <div class="body">
                                <div class="table-responsive">
                                    <table class="table table-bChated table-striped table-hover dataTable js-exportable">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Username</th>
                                        ...
                                        <tbody>
                                            ...
                                            while ($result = mysqli_fetch_array($query)) {
                                                ...
                                                echo "<td>" . htmlentities($result['address']) . "</td>";
