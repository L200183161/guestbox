...
?>
    ...
    <head>
        ...
        <title>GUESTBOOK - Admin Only</title>
        <!-- Favicon-->
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header bg-blue">
                                <h2>
                                    Admin Only <small>Just a simple touch of olive oil</small>
                                </h2>
                            </div>
                            <div class="body">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="info-box-4">
                                <div class="icon">
                                    <i class="material-icons col-indigo">message</i>
                                </div>
                                <div class="content">
                                    <div class="text">Total Message in Guestbook</div>
                                    <div class="number count-to" data-from="0" data-to="<?php echo get_count_from('guestbook'); ?>" data-speed="1500" data-fresh-interval="20"></div>
                                </div>
                            </div>
                            <div class="info-box-4">
                                <div class="icon">
                                ...
                                <div class="content">
                                    <div class="text">Total Guests with Login</div>
